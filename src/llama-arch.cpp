...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_NEXTN_SHARED_HEAD_DOWN,                 "blk.%d.nextn.shared_head_down" },
    { LLM_TENSOR_NEXTN_SHARED_HEAD_UP,                   "blk.%d.nextn.shared_head_up" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_NEXTN_SHARED_HEAD_DOWN,     {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_NEXTN_SHARED_HEAD_UP,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    // Nemotron 3 Super
